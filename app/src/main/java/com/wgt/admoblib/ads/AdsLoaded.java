...
import com.wgt.admoblib.App;

public class AdsLoaded {

    protected final static String BANNER_IN_APP_ID = "ca-app-pub-3940256099942544/6300978111";
    protected final static String INTER_IN_APP_ID = "ca-app-pub-3940256099942544/1033173712";
    protected final static String NATIVE_IN_APP_ID = "ca-app-pub-3940256099942544/2247696110";

    protected final static String INTER_SYSTEM_ID = "";
    protected final static String BANNER_SYSTEM_ID = "";
    protected final static String NATIVE_SYSTEM_ID = "";

    private static AdsLoaded adsLoaded;
    private static final SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(App.get());

    public static AdsLoaded get(){
        if(adsLoaded ==null){
            adsLoaded = new AdsLoaded();
        }
        return adsLoaded;
    }
